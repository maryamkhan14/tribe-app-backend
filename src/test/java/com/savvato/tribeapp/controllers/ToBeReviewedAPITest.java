...
public class ToBeReviewedAPITest {
    ...
    @MockBean
    private ToBeReviewedService toBeReviewedService;
    @MockBean
    ...
    public void getPhraseHappyPath() throws Exception {
        ...
        MvcResult result =
                this.mockMvc
                        .perform(
                                get("/api/phrases-to-review/phrase")
                                        .header("Authorization", "Bearer " + auth)
                                        .characterEncoding("utf-8"))
                        .andExpect(status().isOk())
                        .andReturn();

        Type toBeReviewedDTOType = new TypeToken<ToBeReviewedDTO>() {
        }.getType();
    ...
    public void getPhraseWhenNoneFound() throws Exception {
        ...
        this.mockMvc
                .perform(
                        get("/api/phrases-to-review/phrase").header("Authorization", "Bearer " + auth).characterEncoding("utf-8"))
